...
const Explore = () => {
  ...
  //  }, );
  return (
    <div className="king mb-10">
      <h2 className=" text-center  font-bold text-2xl uppercase  text-teal-500  font-sans">
        Featured Collections
      </h2>
      <h1 className=" text-center  font-semibold capitalize text-3xl ">
      ...
      <div
        className=" cards flex flex-wrap w-[90%]  md: w[100%] mx-auto gap-[30px] justify-center
 "
      >
        <div className="">
          <div className="card-body md:w[30%] p-4 w-[300px] shadow-2xl rounded-3xl md:max-w-2xl  ">
            ...
            <div className=" flex h-5   border border-teal-400 rounded-xl  ">
              {" "}
            ...
            <div className=" flex gap-[30%] pt-10  ">
              ...
              <button className=" bg-blue-500 w-[123px] h-[20px] rounded-full text-white ">
                invest
              </button>
            </div>
          </div>
