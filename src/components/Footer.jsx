function Footer() {
  return (
    <footer className="flex flex-col p-16 font-[Montserrat] max-md:p-6 bg-gradient-to-r from-[#f9f4fb] to-[#fffaec] max-md:bg-gradient-to-b max-md:from-[#f9f4fb] max-md:to-[#fffaec">
      {/* Up part */}
      <div className="flex justify-between items-start space-x-[20rem]  max-md:flex-col max-md:space-x-0 max-md:space-y-3">
      ...
      <div className="flex justify-between items-start space-x-10 max-md:flex-col-reverse max-md:justify-center max-md:items-center max-md:space-x-0">
        <div className="w-full mt-1 max-md:text-center ">
        ...
        <div className="w-full">
          <ul className="flex space-x-6 justify-center items-center [&_li]:cursor-pointer max-md:flex-col max-md:space-x-0 max-md:space-y-3">
            <li>Home</li>
            <li>About Us</li>
            <li>Our Team</li>
            <li>Shop</li>
