function Footer() {
  return (
    <footer className="flex flex-col p-16 font-[Montserrat] max-md:p-6 bg-gradient-to-r from-[#f9f4fb] to-[#fffaec] w-full max-md:[&_h2]:text-[1.2rem]">
      {/* Up part */}
      <div className="flex justify-between items-start space-x-16  max-md:flex-col max-md:space-x-0 max-md:space-y-3">
        ...
        <div className="flex justify-center items-start w-full [&_h2]:text-[1.5rem] space-x-16 max-md:space-x-0  max-md:flex-col max-md:space-y-3">
          ...
          <div className="flex flex-col space-y-2 w-1/2 min-w-[100px]">
