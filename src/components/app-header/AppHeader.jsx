...
function Header({ setIsOpen }) {
  ...
  return (
    <div className="head flex items-center">
      ...
      <div className="head_menu_country small-box  flex items-center justify-center gap-x-4">
        <img
      ...
      <div className="head_menu_notification small-box">
        <FontAwesomeIcon icon={faBellOutline} />
      </div>
      <div className="head_menu_profile-pic small-box">
